...
def _format_notification(entry, unread_cutoff):
    ...
    title_map = {
        ...
        ('send_reports', 'monthly_period'): f'Reports & certificates sent (email/WhatsApp) — {details}',
        ('notify_update', 'monthly_period'): f'Shareholder update sent (email/WhatsApp) — {details}',
        ('export', 'monthly_period'): f'Distribution exported — {details}',
        ('export', 'shareholder'): f'Capital register exported — {details}',
        ('phone_update', 'user'): f'WhatsApp phone updated — {details}',
        ('whatsapp_test', 'system_settings'): f'WhatsApp test sent — {details}',
