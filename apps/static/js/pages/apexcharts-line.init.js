...
const datalabelLineChart = new ApexCharts(
  document.querySelector("#datalabel_line_chart"),
  datalabelLineOptions
);
datalabelLineChart.render();

//
// Zoomable Timeseries
//
const zoomableLineOptions = {
  series: [
    {
      name: "XYZ MOTORS",
      data: [
...
const zoomableLineChart = new ApexCharts(document.querySelector("#zoomable_line_chart"), zoomableLineOptions);
...
const dashedOptions = {
  ...
  colors: ["#E77636", "#001b2f", "#7168EE"],
  grid: {
    borderColor: "#f1f1f1",
  },
};
const dashedChart = new ApexCharts(document.querySelector("#dashed_line_chart"), dashedOptions);
dashedChart.render();
...
const brushLineChart = new ApexCharts(document.querySelector("#brush_line_chart"), brushLineOptions);
brushLineChart.render();

const brushLine1Options = {
  series: [
    {
      data: data,
    },
...
const brushLine1Chart = new ApexCharts(document.querySelector("#brush_line_chart2"), brushLine1Options);
brushLine1Chart.render();

//
// Live Chart With Annotations
//
const annotationsLieOptions = {
  series: [
    {
...
const annotationsLieChart = new ApexCharts(document.querySelector("#annotations_line_chart"), annotationsLieOptions);
annotationsLieChart.render();
...
const stepLineChart = new ApexCharts(document.querySelector("#stepline_line_chart"), stepLineOptions);
...
const gradientLineChart = new ApexCharts(document.querySelector("#gradient_line_chart"), gradientLineOptions);
gradientLineChart.render();

//
// Missing / null values
//
const missingnullLineOptions = {
  series: [
    {
      name: "Peter",
  ...
  xaxis: {},
  colors: ["#7168EE", "#963b68", "#46B277"],
};

const missingnullLineChart = new ApexCharts(document.querySelector("#missingnull_line_chart"), missingnullLineOptions);
missingnullLineChart.render();
...
const realtimeLineChart = new ApexCharts(document.querySelector("#realtime_line_chart"), realtimeLineOptions);
