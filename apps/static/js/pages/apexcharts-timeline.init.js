...
const basicTimelineChart = new ApexCharts(document.querySelector("#basic_timeline_chart"), basicTimelineOptions);
...
const distributedChart = new ApexCharts(document.querySelector("#distributed_timeline_chart"), distributedOptions);
distributedChart.render();
...
const multiSeriesChart = new ApexCharts(document.querySelector("#multi_timeline_chart"), multiSeriesOptions);
...
const advancedChart = new ApexCharts(document.querySelector("#advanced_timeline_chart"), advancedOptions);
advancedChart.render();

//
// Multiple series – Group rows
//
const multipleGroupOptions = {
  series: [
    // George Washington
    {
...
const multipleGroupChart = new ApexCharts(document.querySelector("#group_timeline_chart"), multipleGroupOptions);
multipleGroupChart.render();
...
const dumbbellChart = new ApexCharts(document.querySelector("#dumbbell_timeline_chart"), dumbbellOptions);
